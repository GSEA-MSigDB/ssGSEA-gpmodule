...
# and creates an R matrix with each row corresponding to a single
# gene set and containing a list of the gene names making up
# that gene set.  gene sets that do not satisfy the min and max threshold criteria
# will be filtered out
#
# note: do not support gene.names argument, which was always set to NULL in Read.GeneSets.gmt and thus ignored
